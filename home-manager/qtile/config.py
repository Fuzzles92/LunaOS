...
keys = [
    ...
    Key([mod], "F10", lazy.spawn("pamixer -d 5")), # Decrease %5
    Key([mod], "F11", lazy.spawn("pamixer -i 5")), # Increase %5
    Key([mod], "F12", lazy.spawn("pamixer -t")), # Mute
